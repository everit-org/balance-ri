...
/**
 * Constants of the {@link BalanceTransferCompnent}.
 */
public final class BalanceTransferConstants {

    /**
     * The component name of the {@link BalanceTransferCompnent}.
     */
    public static final String COMPONENT_NAME = "org.everit.osgi.balance.ri.BalanceTransfer";

    /**
     * The property name of the OSGi filter expression defining which
     * {@link org.everit.osgi.resource.api.ResourceService} should be used by {@link BalanceTransferCompnent}.
     */
    ...
    public static final String PROP_BALANCE_ACCOUNT_SERVICE_TARGET = "balanceAccountService.target";

    private BalanceTransferConstants() {
    }
